          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              <p className="text-sm text-gray-500 tracking-wide leading-5">
                ...
                modi tempora facere voluptates ab tempore nobis exercitationem
                mollitia asperiores aliquam. Exercitationem, nesciunt
                aspernatur. Earum at magnam et doloribus consequatur quia!
              </p>

              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-5">
                  <div className="flex items-center gap-3">
                    <GrSecure className="text-2xl h-12 w-12 p-3 shadow-sm rounded-full bg-red-100" />
                    <span>Premium Coffee</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <IoFastFood className="text-2xl h-12 w-12 p-3 shadow-sm rounded-full bg-orange-100" />
                    <span>Hot Coffee</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <GiFoodTruck className="text-2xl h-12 w-12 p-3 shadow-sm rounded-full bg-yellow-100" />
